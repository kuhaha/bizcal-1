  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      ...
      <svg width="20" height="20" fill="currentColor" class="bi bi-table"><use xlink:href="#table"/></svg>
        <strong class="text-white">&nbsp;KsuCalendar</strong>
      </a>
...
<main>
  ...
  <div class="album py-5 bg-light">
    <div class="container">
    <div class="row">    
      <h2 class="display-5"><?=$year?> Business Calendar</h2>
    </div>
    ...
    <?php
      foreach (range(3,14) as $m){
        ...
        echo '<div class="card shadow-sm h-100">', PHP_EOL; 
        ...
        echo $table;
        echo '<div class="text-sm">'.implode("；\n", $days).'</div>';
        echo '</div>', PHP_EOL;         
        echo '</div>',  PHP_EOL;
        echo '</div>',  PHP_EOL;
      }
